...
namespace App\Filament\Admin\Clusters\Transactions\Resources\Transactions;

use App\Filament\Admin\Clusters\Transactions\Resources\Transactions\Pages\CreateTransaction;
use App\Filament\Admin\Clusters\Transactions\Resources\Transactions\Pages\ListTransactions;
use App\Filament\Admin\Clusters\Transactions\Resources\Transactions\Pages\ViewTransaction;
use App\Filament\Admin\Clusters\Transactions\Resources\Transactions\RelationManagers\TransactionMetadataRelationManager;
...
use Misaf\Caspianpay\Actions\Shops\VerifyAction;
use Misaf\Caspianpay\Actions\Shops\VerifyShetabCashoutAction;
                ...
                ActionGroup::make([
                    ...
                    Action::make('deposit-info')
                        ...
                        ->modalContent(function (Transaction $record) {
                            return view('filament.admin.resources.transactions.actions.caspianpay', ['data' => (new VerifyAction())
                                ->execute([
                                    'id' => $record->transactionMetadatas()->where('key_name', 'id')->value('key_value'),
                                ])]);
                        })
                        ->visible(function (Transaction $record): bool {
                            return TransactionService::isDeposit($record)
                                && $record->transactionGateway->id === TransactionService::getTransactionGateway('caspianpay')->id;
                        }),
                    ...
                    Action::make('withdrawal-info')
                        ...
                        ->modalCancelAction(false)
                        ->modalContent(function (Transaction $record) {
                            return view('filament.admin.resources.transactions.actions.caspianpay', ['data' => (new VerifyShetabCashoutAction())
                                ->execute([
                                    'id' => $record->transactionMetadatas()->where('key_name', 'id')->value('key_value'),
                                ])]);
                        })
