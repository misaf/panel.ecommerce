...
final class ConsolePanelServiceProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->discoverPages(app_path('Filament/Console/Pages'), 'App\\Filament\\Console\\Pages')
            ->discoverWidgets(app_path('Filament/Console/Widgets'), 'App\\Filament\\Console\\Widgets')
