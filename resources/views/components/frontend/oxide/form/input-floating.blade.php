<div>
    <div class="relative">
        <x-buk-input {{ $attributes->merge(['class' => 'dark:bg-gray-700 dark:bg-gradient-to-t dark:from-gray-800 block rounded-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 border-0 border-gray-300 appearance-none dark:text-white dark:border-gray-600 focus:outline-none peer focus:ring-0']) }} autocomplete="off" placeholder=" " />
