...
- Keep the read-only Filament resource under `src/Filament/Resources`, delegate table configuration to `Tables/AuthifyLogTable.php`, and preserve its shared `SystemCluster` assignment. Do not add a form schema unless authentication logs intentionally become editable.
