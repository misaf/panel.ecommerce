...
- Keep the read-only Filament resource under `src/Filament/Resources`, delegate table configuration to `Tables/MultimediaTable.php`, and preserve its shared `ContentCluster` assignment. Do not add a form schema unless media records intentionally become editable here.
