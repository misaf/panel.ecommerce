...
- Keep the read-only Filament resource under `src/Filament/Resources`, delegate table configuration to `Tables/ActivityLogTable.php`, and preserve its shared `SystemCluster` assignment. Do not add a form schema unless activity records intentionally become editable.
