...
- Run module checks from the package when possible: `composer --working-dir=packages/vendra-activity-log test` and `composer --working-dir=packages/vendra-activity-log analyse`.
