...
- Add or update focused Pest coverage, then run `composer --working-dir=packages/vendra-currency test` and `composer --working-dir=packages/vendra-currency analyse`.
