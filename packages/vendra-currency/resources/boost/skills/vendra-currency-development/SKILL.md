...
- Run module checks from the package when possible: `composer --working-dir=packages/vendra-currency test` and `composer --working-dir=packages/vendra-currency analyse`.
