...
description: "Use this skill when creating, modifying, reviewing, or testing the Vendra Geo module in app-modules/vendra-geo, or when creating future geo-like Filament/domain modules. Trigger for `Country`, `State`, `City` models, vendra-geo migrations, factories, seeders, policies, permission enums, Filament resources, clusters, forms, tables, relation managers, translations, media collections, plugin/service provider wiring, and module configuration."
---
...
Treat `app-modules/vendra-geo` as the source of geo domain behavior and Filament admin UI.
...
- Run module checks from the package when possible: `composer --working-dir=app-modules/vendra-geo test` and `composer --working-dir=app-modules/vendra-geo analyse`.
