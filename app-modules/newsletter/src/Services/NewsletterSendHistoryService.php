...
final class NewsletterSendHistoryService
{
    ...
    /**
     * Get count of send histories (optionally for a specific newsletter)
     *
     * @param Newsletter|null $newsletter
     * @return int
     */
    ...
    /**
     * Clear all newsletter send history cache
     *
     * Removes all cached data for send histories.
     * This is automatically called when send histories are saved or deleted.
     *
     * @return void
     */
