...
final class NewsletterSendHistorySubscriberService
{
    ...
    /**
     * Get count of send history subscribers (optionally for a specific newsletter)
     *
     * @param Newsletter|null $newsletter
     * @return int
     */
    ...
    /**
     * Clear all newsletter send history subscriber cache
     *
     * Removes all cached data for send history subscribers.
     * This is automatically called when send history subscribers are saved or deleted.
     *
     * @return void
     */
