...
final class NewsletterSendHistoryPostService
{
    ...
    /**
     * Get count of send history posts (optionally for a specific newsletter)
     *
     * @param Newsletter|null $newsletter
     * @return int
     */
    ...
    /**
     * Clear all newsletter send history post cache
     *
     * Removes all cached data for send history posts.
     * This is automatically called when send history posts are saved or deleted.
     *
     * @return void
     */
